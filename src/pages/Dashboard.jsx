  ...
  return (
    <div className="min-h-dvh bg-ink px-5 pt-8 pb-10 flex flex-col">
      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        >
          <div>
            <p className="font-display text-2xl font-semibold text-foam">Clientes</p>
            <p className="text-muted mt-1">Cuenta corriente y pagos</p>
          </div>
          <span className="text-4xl font-display text-gol">→</span>
        </Link>
        ...
        >
          <div>
            <p className="font-display text-2xl font-semibold text-foam">Formas de pago</p>
            <p className="text-muted mt-1">Efectivo, tarjeta, y las que sumes</p>
          </div>
          <span className="text-4xl font-display text-gol">→</span>
        </Link>
      </div>
